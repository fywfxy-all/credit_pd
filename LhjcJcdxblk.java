...
@Data
@Entity
@Table(name = "lhjc_jcdx_blk")
public class LhjcJcdxblk extends BaseEntity implements Serializable {

    private static final long serialVersionUID = 7898433623192131115L;
